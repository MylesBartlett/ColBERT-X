...
class Arguments:
    ...
    def add_model_parameters(self):
        ...
        self.add_argument(
            "--mask-punctuation", dest="mask_punctuation", default=False, action="store_true"
        )
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument(
            "--resume_optimizer", dest="resume_optimizer", default=False, action="store_true"
        )
    ...
    def add_training_input(self):
        self.add_argument("--base_model", dest="base_model", default="xlm-roberta-large")
